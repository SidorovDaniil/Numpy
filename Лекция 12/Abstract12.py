...
# Пример
# Пусть есть два шеститигранных кубика
# K1 = {1, 2, 3, 4, 5, 6}
# K2 = {1, 2, 3, 4, 5, 1}
# Гипотеза (А): выбран K1 | выбран K2
# Событие (В): после броска выпало 1, 2, 3, 4, 5, 6
...
#Бинарная классификация L1 или L2
# P(L1|признаки) = P(признаки|L1) * P(L1)/P(признаки)
# P(L2|признаки) = P(признаки|L2) * P(L2)/P(признаки)

# P(L1|признаки)/P(L2|признаки) = P(признаки|L1) * P(L1)/( P(признаки|L2) * P(L2) )
